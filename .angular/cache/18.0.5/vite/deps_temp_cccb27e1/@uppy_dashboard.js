...
} from "./chunk-RNFSLBC6.js";
import "./chunk-A4RPM44R.js";
import {
  F as F2,
  T,
  _ as _2,
...
var c = class _c {
  ...
  constructor(e2, t2 = 0, s2, i2) {
    if ("boolean" == typeof i2 && (this.le = i2), Array.isArray(e2) && (e2 = new Uint8Array(e2)), 0 === e2)
      ...
      l("Invalid input argument for BufferView: " + e2);
  }
  _swapArrayBuffer(e2) {
  ...
  getUnicodeString(e2 = 0, t2 = this.byteLength) {
    const s2 = [];
    for (let i2 = 0; i2 < t2 && e2 + i2 < this.byteLength; i2 += 2)
      s2.push(this.getUint16(e2 + i2));
    return u(s2);
  }
  getInt8(e2) {
  ...
  constructor(t2, s2, i2, n2) {
    if (super(), e(this, "enabled", false), e(this, "skip", /* @__PURE__ */ new Set()), e(this, "pick", /* @__PURE__ */ new Set()), e(this, "deps", /* @__PURE__ */ new Set()), e(this, "translateKeys", false), e(this, "translateValues", false), e(this, "reviveValues", false), this.key = t2, this.enabled = s2, this.parse = this.enabled, this.applyInheritables(n2), this.canBeFiltered = P.includes(t2), this.canBeFiltered && (this.dict = B.get(t2)), void 0 !== i2)
      if (Array.isArray(i2))
        ...
        true === i2 || false === i2 ? this.parse = this.enabled = i2 : l(`Invalid options argument: ${i2}`);
  }
  applyInheritables(e2) {
    let t2, s2;
    for (t2 of E)
      s2 = e2[t2], void 0 !== s2 && (this[t2] = s2);
  }
  translateTagSet(e2, t2) {
    if (this.dict) {
      let s2, i2, { tagKeys: n2, tagValues: r2 } = this.dict;
      for (s2 of e2)
        "string" == typeof s2 ? (i2 = r2.indexOf(s2), -1 === i2 && (i2 = n2.indexOf(Number(s2))), -1 !== i2 && t2.add(Number(n2[i2]))) : t2.add(s2);
    } else
      for (let s2 of e2)
        t2.add(s2);
  }
...
var R = class extends _3 {
  ...
  setupFromUndefined() {
    ...
    for (e2 of j2)
      this[e2] = N[e2];
    for (e2 of F3)
      this[e2] = new D(e2, N[e2], void 0, this);
  }
  setupFromTrue() {
    let e2;
    for (e2 of L)
    ...
    for (e2 of j2)
      this[e2] = true;
    for (e2 of F3)
      this[e2] = new D(e2, true, void 0, this);
  }
  setupFromArray(e2) {
    let t2;
    for (t2 of L)
    ...
    for (t2 of j2)
      this[t2] = N[t2];
    for (t2 of F3)
      this[t2] = new D(t2, false, void 0, this);
    this.setupGlobalFilters(e2, void 0, P);
  }
  setupFromObject(e2) {
    let t2;
    for (t2 of (P.ifd0 = P.ifd0 || P.image, P.ifd1 = P.ifd1 || P.thumbnail, Object.assign(this, e2), L))
      this[t2] = W(e2[t2], N[t2]);
    for (t2 of M)
      this[t2] = W(e2[t2], N[t2]);
    for (t2 of j2)
      this[t2] = W(e2[t2], N[t2]);
    for (t2 of z)
      this[t2] = new D(t2, N[t2], e2[t2], this);
    for (t2 of P)
      this[t2] = new D(t2, N[t2], e2[t2], this.tiff);
  ...
  setupGlobalFilters(e2, t2, s2, i2 = s2) {
    if (e2 && e2.length) {
      ...
      let t3 = K(e2, s2);
      for (let [e3, s3] of t3)
        X(this[e3].pick, s3), this[e3].enabled = true;
  ...
  checkLoadedPlugins() {
    for (let e2 of z)
      this[e2].enabled && !y2.has(e2) && p2("segment parser", e2);
  }
};
function K(e2, t2) {
  let s2, i2, n2, r2, a2 = [];
  for (n2 of t2) {
    for (r2 of (s2 = B.get(n2), i2 = [], s2))
      (e2.includes(r2[0]) || e2.includes(r2[1])) && i2.push(r2[0]);
...
var H = class {
  ...
  setup() {
    ...
    for (let [s2, i2] of m)
      if (i2.canHandle(e2, t2))
        return this.fileParser = new i2(this.options, this.file, this.parsers), e2[s2] = true;
  ...
  extractThumbnail() {
    return __async(this, null, function* () {
      ...
      var i2;
      if (t2.tiff ? i2 = { start: 0, type: "tiff" } : t2.jpeg && (i2 = yield this.fileParser.getOrFindSegment("tiff")), void 0 === i2)
        return;
...
var G = Object.freeze({ __proto__: null, parse: Y, Exifr: H, fileParsers: m, segmentParsers: y2, fileReaders: b, tagKeys: B, tagValues: V, tagRevivers: I, createDictionary: x2, extendDictionary: C, fetchUrlAsArrayBuffer: S, readBlobAsArrayBuffer: A, chunkedProps: L, otherSegments: T2, segments: z, tiffBlocks: P, segmentsAndBlocks: F3, tiffExtractables: j2, inheritables: E, allFormatters: M, Options: R });
var J = class {
  ...
  translateBlock(e2, t2) {
    ...
    for (let [t3, r3] of e2)
      a2 && s2.has(t3) ? r3 = s2.get(t3)(r3) : h3 && i2.has(t3) && (r3 = this.translateValue(r3, i2.get(t3))), f2 && n2.has(t3) && (t3 = n2.get(t3) || t3), l2[t3] = r3;
    return l2;
  }
...
var ee = class extends class {
  constructor(t2, s2, i2) {
    e(this, "errors", []), e(this, "ensureSegmentChunk", (e2) => __async(this, null, function* () {
      ...
      if (this.file.chunked)
        if (this.file.available(t3, s3))
          e2.chunk = this.file.subarray(t3, s3);
        else
          try {
        ...
        this.file.byteLength > t3 + s3 ? e2.chunk = this.file.subarray(t3, s3) : void 0 === e2.size ? e2.chunk = this.file.subarray(t3) : l("Segment unreachable: " + JSON.stringify(e2));
      return e2.chunk;
    ...
    return __async(this, null, function* () {
      ...
      if (!i2 && this.file.chunked && (i2 = Array.from(n2).some((e3) => {
        ...
        for (; r2.size > 0 && !t3 && (s2.canReadNextChunk || this.unfinishedMultiSegment); ) {
          ...
          if (t3 = e2 > i3 && !n3 ? !(yield s2.readNextChunk(e2)) : !(yield s2.readNextChunk(i3)), void 0 === (e2 = this.findAppSegmentsInRange(e2, s2.byteLength)))
            return;
        }
      }
    });
  ...
  findAppSegmentsInRange(e2, t2) {
    t2 -= 2;
    let s2, i2, n2, r2, a2, h3, { file: f2, findAll: l2, wanted: o2, remaining: u2, options: d3 } = this;
    for (; e2 < t2; e2++)
      if (255 === f2.getUint8(e2)) {
        if (s2 = f2.getUint8(e2 + 1), Q(s2)) {
          if (i2 = f2.getUint16(e2 + 2), n2 = Z(f2, e2, i2), n2 && o2.has(n2) && (r2 = y2.get(n2), a2 = r2.findPosition(f2, e2), h3 = d3[n2], a2.type = n2, this.appSegments.push(a2), !l2 && (r2.multiSegment && h3.multiSegment ? (this.unfinishedMultiSegment = a2.chunkNumber < a2.chunkCount, this.unfinishedMultiSegment || u2.delete(n2)) : u2.delete(n2), 0 === u2.size)))
            break;
          d3.recordUnknownSegments && (a2 = J.findPosition(f2, e2), a2.marker = s2, this.unknownSegments.push(a2)), e2 += i2 + 1;
        } else if (q(s2)) {
          if (i2 = f2.getUint16(e2 + 2), 218 === s2 && false !== d3.stopAfterSos)
            return;
  ...
  mergeMultiSegments() {
    ...
    let e2 = function(e3, t2) {
      ...
      for (let a2 = 0; a2 < e3.length; a2++)
        s2 = e3[a2], i2 = s2[t2], r2.has(i2) ? n2 = r2.get(i2) : r2.set(i2, n2 = []), n2.push(s2);
...
var se = class extends J {
  ...
  parseTags(e2, t2, s2 = /* @__PURE__ */ new Map()) {
    ...
    for (let f2 = 0; f2 < h3; f2++) {
      ...
      if (r2) {
        if (i2.has(h4) && (s2.set(h4, this.parseTag(e2, h4, t2)), i2.delete(h4), 0 === i2.size))
          break;
      } else
        !a2 && n2.has(h4) || s2.set(h4, this.parseTag(e2, h4, t2));
      e2 += 12;
    }
    return s2;
  }
  parseTag(e2, t2, s2) {
    ...
    if (a2 * r2 <= 4 ? e2 += 8 : e2 = i2.getUint32(e2 + 8), (n2 < 1 || n2 > 13) && l(`Invalid TIFF value type. block: ${s2.toUpperCase()}, tag: ${t2.toString(16)}, type: ${n2}, offset ${e2}`), e2 > i2.byteLength && l(`Invalid TIFF value offset. block: ${s2.toUpperCase()}, tag: ${t2.toString(16)}, type: ${n2}, offset ${e2} is outside of chunk size ${i2.byteLength}`), 1 === n2)
      return i2.getUint8Array(e2, r2);
    if (2 === n2)
      return "" === (h3 = function(e3) {
        for (; e3.endsWith("\0"); )
          e3 = e3.slice(0, -1);
        return e3;
      ...
      return this.parseTagValue(n2, e2);
    {
      ...
      for (let i3 = 0; i3 < r2; i3++)
        t3[i3] = this.parseTagValue(n2, e2), e2 += s3;
      return t3;
    }
  }
  parseTagValue(e2, t2) {
...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e2.byteLength}`), e2.tiff && (yield e2.ensureChunk(this.ifd0Offset, o(this.options)));
  ...
  parseExifBlock() {
    return __async(this, null, function* () {
      if (this.exif)
        return;
      if (this.ifd0 || (yield this.parseIfd0Block()), void 0 === this.exifOffset)
        return;
  ...
  parseGpsBlock() {
    return __async(this, null, function* () {
      if (this.gps)
        return;
      if (this.ifd0 || (yield this.parseIfd0Block()), void 0 === this.gpsOffset)
        return;
  ...
  parseInteropBlock() {
    return __async(this, null, function* () {
      if (!this.interop && (this.ifd0 || (yield this.parseIfd0Block()), void 0 !== this.interopOffset || this.exif || (yield this.parseExifBlock()), void 0 !== this.interopOffset))
  ...
  extractThumbnail() {
    return __async(this, null, function* () {
      if (this.headerParsed || this.parseHeader(), this.ifd1Parsed || (yield this.parseThumbnailBlock(true)), void 0 === this.ifd1)
        return;
  ...
  createOutput() {
    ...
    for (t2 of P)
      if (e2 = this[t2], !f(e2))
        if (s2 = this.canTranslate ? this.translateBlock(e2, t2) : Object.fromEntries(e2), this.options.mergeOutput) {
          if ("ifd1" === t2)
            continue;
          Object.assign(i2, s2);
        } else
  ...
  assignToOutput(e2, t2) {
    if (this.globalOptions.mergeOutput)
      ...
      for (let [s2, i2] of Object.entries(t2))
        this.assignObjectToOutput(e2, s2, i2);
  }
};
...
var we = class {
  ...
  add(e2, t2, s2 = 0) {
    ...
    if (n2.length > 0) {
      ...
      this.list.push({ offset: e2, length: t2, end: i2 });
  }
  available(e2, t2) {
    let s2 = e2 + t2;
