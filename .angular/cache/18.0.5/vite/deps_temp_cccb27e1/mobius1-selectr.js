  ...
  "node_modules/mobius1-selectr/dist/selectr.min.js"(exports, module) {
    (function(g, k) {
      ...
      l.prototype = { on: function(a, c) {
        ...
        this._events = this._events || {};
        if (false !== a in this._events)
          for (var c = 0; c < this._events[a].length; c++)
            this._events[a][c].apply(this, Array.prototype.slice.call(arguments, 1));
      } };
      l.mixin = function(a) {
        for (var c = ["on", "off", "emit"], b2 = 0; b2 < c.length; b2++)
          "function" === typeof a ? a.prototype[c[b2]] = l.prototype[c[b2]] : a[c[b2]] = l.prototype[c[b2]];
        return a;
      };
      var b = { extend: function(a, c) {
        for (var e in c)
        ...
        if ("[object Object]" === Object.prototype.toString.call(a))
          for (var d in a)
            Object.prototype.hasOwnProperty.call(a, d) && c.call(b2, d, a[d], a);
        else {
          d = 0;
        ...
        if (a)
          return a.classList ? a.classList.contains(b2) : !!a.className && !!a.className.match(new RegExp("(\\s|^)" + b2 + "(\\s|$)"));
        ...
        if (this.items.length) {
          ...
          if (this.config.pagination) {
            ...
            b.each(this.items, function(b2, d) {
              n(
                d,
                a,
                this.customOption
        ...
        this.container = b.createElement(
          "div",
        ...
        this.selected = b.createElement("div", { "class": "selectr-selected", disabled: this.disabled, tabIndex: 0, "aria-expanded": false });
        ...
        this.tree = b.createElement("ul", { "class": "selectr-options", role: "tree", "aria-hidden": true, "aria-expanded": false });
        ...
        this.config.clearable && (this.selectClear = b.createElement("button", { "class": "selectr-clear", type: "button" }), this.container.appendChild(this.selectClear), b.addClass(this.container, "clearable"));
        ...
        this.el.children.length && b.each(this.el.children, function(a2, c2) {
          "OPTGROUP" === c2.nodeName ? (e = b.createElement("ul", { "class": "selectr-optgroup", role: "group", html: "<li class='selectr-optgroup--label'>" + c2.label + "</li>" }), b.each(c2.children, function(a3, b2) {
            b2.idx = d;
        ...
        if (this.config.data && Array.isArray(this.config.data)) {
          ...
          b.each(this.config.data, function(a2, c2) {
            k(c2, "children") ? (f = b.createElement("optgroup", { label: c2.text }), e = b.createElement("ul", {
        ...
        for (var g2 = this.navIndex = 0; g2 < this.items.length; g2++)
          if (c = this.items[g2], !b.hasClass(c, "disabled")) {
            b.addClass(c, "active");
            this.navIndex = g2;
            break;
          }
        ...
        if (this.items.length && this.opened && b.includes([13, 38, 40], a.which)) {
          a.preventDefault();
          if (13 === a.which)
            return this.noResults || this.config.taggable && 0 < this.input.value.length ? false : this.change(this.navIndex);
          ...
          for (this.navigating = true; b.hasClass(
            this.items[this.navIndex],
            "disabled"
        ...
        if (this.config.sortSelected) {
          ...
          a.sort(function(a2, b2) {
            ...
            if (true === c.config.sortSelected) {
              ...
              "text" === c.config.sortSelected && (f2 = a2.textContent, h2 = b2.textContent);
            g2(f2, d2);
            for (g2(h2, e2); d2.length && e2.length; )
              if (f2 = d2.shift(), h2 = e2.shift(), f2 = f2[0] - h2[0] || f2[1].localeCompare(h2[1]))
                return f2;
        ...
        c && (this.label.removeChild(c), this.tags.splice(
          this.tags.indexOf(c),
          1
        ));
      }, r = function() {
        ...
        if (this.config.searchable || this.config.taggable)
          this.input.value = null, this.searching = false, this.config.searchable && b.removeClass(this.inputContainer, "active"), b.hasClass(this.container, "notice") && (b.removeClass(this.container, "notice"), b.addClass(this.container, "open"), this.input.focus()), b.each(this.items, function(a, c) {
      ...
      g.prototype.detectEventPassiveOption = function() {
        var a = false;
        try {
          var b2 = Object.defineProperty({}, "passive", { get: function() {
            a = true;
          } });
      ...
      g.prototype.bindEvents = function() {
        ...
        if (this.config.nativeDropdown || this.mobileDevice) {
          ...
          var c = function(a2, b2) {
            for (var d = [], c2 = a2.slice(0), e2, f = 0; f < b2.length; f++)
              e2 = c2.indexOf(b2[f]), -1 < e2 ? c2.splice(e2, 1) : d.push(b2[f]);
            return [d, c2];
          };
        ...
        if (this.config.nativeKeyboard) {
          ...
          this.selected.addEventListener("keydown", function(b2) {
            if (!(a.disabled || a.selected !== document.activeElement || b2.altKey || b2.ctrlKey || b2.metaKey)) {
              if (" " === b2.key || !a.opened && -1 < ["Enter", "ArrowUp", "ArrowDown"].indexOf(b2.key))
                a.toggle(), b2.preventDefault(), b2.stopPropagation();
                ...
                if (a.config.multiple)
                  a.open(), a.config.searchable && (a.input.value = b2.key, a.input.focus(), a.search(null, true));
                else {
                  e += b2.key;
        ...
        this.config.searchable && (this.input.addEventListener(
          "focus",
          function(b2) {
            a.searching = true;
          }
        ...
        this.config.taggable && this.input.addEventListener("keyup", function(c2) {
          ...
          if (a.config.taggable && this.value.length) {
            ...
            if (13 === c2.which || b.includes(a.tagSeperators, c2.key))
              b.each(a.tagSeperators, function(a2, b2) {
                d = d.replace(b2, "");
              }), a.add({ value: d, text: d, selected: true }, true) ? (a.close(), q.call(a)) : (this.value = "", a.setMessage(a.config.messages.tagDuplicate));
          }
        });
          ...
          if (0 < a.length) {
            ...
            b.each(this.options, function(c2, h) {
              ...
              if (g2(h.textContent.trim().toLowerCase(), a) && !h.disabled) {
                if (d.push({ text: h.textContent, value: h.value }), e && (n(k3, f, this.customOption), b.removeClass(k3, "excluded"), !this.customOption)) {
                  var l3 = (l3 = new RegExp(a, "i").exec(h.textContent)) ? h.textContent.replace(l3[0], "<span class='selectr-match'>" + l3[0] + "</span>") : false;
                  k3.innerHTML = l3;
                }
              } else
                e && b.addClass(k3, "excluded");
            }, this);
            if (e) {
              if (f.childElementCount) {
                ...
                this.config.taggable || (this.noResults = true, this.setMessage(this.config.messages.noResults));
      ...
      g.prototype.open = function() {
        ...
        this.opened = true;
        this.mobileDevice || this.config.nativeDropdown ? (b.addClass(
          this.container,
          "native-open"
        ), this.config.data && b.each(this.options, function(a2, b2) {
          this.el.add(b2);
      ...
      g.prototype.serialise = function(a) {
        var c = [];
        b.each(this.options, function(a2, b2) {
          var d = { value: b2.value, text: b2.textContent };
      ...
      g.prototype.getOptionByValue = function(a) {
        for (var b2 = false, e = 0, d = this.options.length; e < d; e++)
